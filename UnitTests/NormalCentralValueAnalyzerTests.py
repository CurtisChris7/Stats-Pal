...
class NormalCentralValueAnalyzerTests(unittest.TestCase):
    ...
    def test_constructor_normalDistNone(self):
        ...
        self.assertRaises(ValueError, NormalCentralValueAnalyzer, values = TEST_VALUES_A, normalDist=None)

    def test_getMean_whenCalled(self):
        """Tests the value of getMean when called"""
        analyzer: NormalCentralValueAnalyzer = NormalCentralValueAnalyzer(TEST_VALUES_A)
